...
<head>
    <meta charset="UTF-8">
    <title>Tabel 2.a.2 Kerjasama Penelitian - LKPS</title>
...
<body class="pb-5">
    ...
    <div class="container mt-5">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted">Pendataan lembaga mitra, durasi kerjasama, dan bukti kegiatan pelaksanaan bidang penelitian.</p>
        </div>
        ...
        <div class="card card-custom p-4 mb-5">
            <h5 class="fw-bold mb-4 border-bottom pb-2">Form Tambah Kerjasama Penelitian</h5>
            <form action="{{ route('kerjasama_penelitian.store') }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Judul Kegiatan Penelitian</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="manfaat" class="form-control" placeholder="Cth: Joint riset dan publikasi dosen" required>
                    </div>
                </div>
        ...
        <div class="card card-custom p-4">
            <h5 class="fw-bold mb-3 border-bottom pb-2">Daftar Kerjasama Penelitian</h5>
            <div class="table-responsive">
                <table class="table table-hover table-bordered text-center align-middle" style="font-size: 0.9rem;">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="text-muted py-4">Belum ada data kerjasama penelitian yang diinput.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
