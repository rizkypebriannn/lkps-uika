<x-app-layout>
    ...
    <div class="d-flex justify-content-center gap-2">
        <a href="{{ route('beban_kerja_dosen.edit', $item->id) }}" class="btn btn-sm text-warning p-0" title="Edit">
            <i class="bi bi-pencil-fill"></i>
        </a>
        <form action="{{ route('beban_kerja_dosen.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus data dosen ini?');">
            @csrf @method('DELETE')
