                    ...
                    <table class="table table-sm table-bordered align-middle text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->lulus_3_5 ?? 0 }}</td>
                                <td>{{ $item->lulus_4_5 ?? 0 }}</td>
                                <td>{{ $item->lulus_5_5 ?? 0 }}</td>
                                <td>{{ $item->lulus_6_5 ?? 0 }}</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('masa_studi_lulusan.edit', $item->id) }}" class="btn btn-sm text-warning p-0" title="Edit">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>
                                        <form action="{{ route('masa_studi_lulusan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                            @csrf @method('DELETE')
