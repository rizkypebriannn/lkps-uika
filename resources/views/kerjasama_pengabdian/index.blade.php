...
<head>
    <meta charset="UTF-8">
    <title>Tabel 2.a.3 Kerjasama PkM - LKPS</title>
...
<body class="pb-5">
    ...
    <div class="container mt-5">
        ...
        <div class="mb-4">
            <h3 class="fw-bold m-0">Tabel 2.a.3 Kerjasama Tridharma (Pengabdian Kepada Masyarakat)</h3>
            <p class="text-muted">Pendataan lembaga mitra, durasi, dan bukti pelaksanaan bidang PkM.</p>
        </div>
        ...
        <div class="card card-custom p-4 mb-5">
            <h5 class="fw-bold mb-4 border-bottom pb-2">Form Tambah Kerjasama PkM</h5>
            <form action="{{ route('kerjasama_pengabdian.store') }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Judul Kegiatan PkM</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="manfaat" class="form-control" placeholder="Cth: Penerapan ilmu bagi desa binaan" required>
                    </div>
                </div>
        ...
        <div class="card card-custom p-4">
            <h5 class="fw-bold mb-3 border-bottom pb-2">Daftar Kerjasama Pengabdian Masyarakat</h5>
            <div class="table-responsive">
                <table class="table table-hover table-bordered text-center align-middle" style="font-size: 0.9rem;">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="text-muted py-4">Belum ada data kerjasama PkM yang diinput.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
